...
class ControllerTournament:
    """
    Controller class responsible for managing and displaying the views of a tournament.
    It interacts with tournament data from the database and to display datas requested by user.
    """
    ...
    def start(self):
        """ Main loop, select between the view of a non-started tournament, a started tournament or an exit. """
        while True:
    ...
    def start_new_tournament(self):
        """ Loop of a non-started tournament, mainly used to add players to the tournament. """
    ...
    def start_match(self, selected_match):
        """ Loop of a specific match, allow the user to change result of a specific match. """
    ...
    def reformat_match_result(match_score, player_left_id, player_right_id):
        """ Use the score stored in a match to send the right datas to display to the view. """
    ...
    def reformat_id_name(self):
        """ Prepare the datas of the players not already participant of a tournament for display in the view. """
    ...
    def reformat_round_status(self):
        """ Prepare the datas of the rounds of a tournament for display in the view. """
        round_list = []
